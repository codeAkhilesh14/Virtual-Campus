...
const ExploreCourses = () => {
  ...
  return (
    <div className="w-[100vw] min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row items-center justify-center 
    gap-4 px-[30px]">
      {/* left/top div */}
      <div className='w-[100%] lg:w-[350px] lg:h-[100%] h-[400px] flex flex-col items-start justify-center gap-1
      md:px-[40px] px-[20px]'>
        <span className='text-[35px] font-semibold'>Explore Our Courses</span>
        <span className='text-[35px] font-semibold'></span>
        <p className='text-[17px]'>Explore courses designed for college students. Learn development, DSA, and
        career skills at your own pace, boost your CGPA, and become job-ready while connecting with mentors and peers.</p>
