...
const EditCourse = () => {
  ...
  const thumb = useRef() // isse courseId mil jayega
  ...
  return (
    <div className='max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md'>
      ...
      <div className='flex items-center justify-center gap-[20px] md:justify-between flex-col md:flex-row mb-6 relative'>
        <FaArrowLeftLong className='w-[22px] absolute top-[-20%] md:top-[20%] left-[0] md:left-[2%] h-[22px] cursor-pointer' 
      ...
      <div className='bg-gray-50 p-6 rounded-md'>
        ...
        <div className='space-x-2 space-y-2'>
          {
            !isPublished ?
            <button className='bg-green-100 text-green-600 px-4 py-2 rounded-md border-1'
        ...
        <form className='space-y-6' onSubmit={(e)=>e.preventDefault()}>
          <div>
            ...
            <input type="text" id="title" className='w-full border px-4 py-2 rounded-md' placeholder='CourseTitle'
          ...
          <div>
            ...
            <textarea type="text" id="des" className='w-full border px-4 py-2 rounded-md h-24 resize-none' placeholder='Course Description'
          ...
          <div className='relative w-[300px] h-[170px]'>
            <img src={frontendImage} alt="thumbnail" onClick={()=>thumb.current.click()}
          ...
          <div className='flex items-center justify-start gap-[15px]'>
              <button className='bg-[#e9e8e8] hover:bg-red-200 text-black border-1 border-black 
