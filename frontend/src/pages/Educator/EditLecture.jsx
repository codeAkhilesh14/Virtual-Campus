  ...
  return (
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
      <div className='w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6'>
        ...
        transition-all text-sm' disabled={loading1} onClick={removeLecture}>
        ...
        <div className='space-y-4'>
            ...
            <div>
                ...
                <input type="file" className='w-full border border-gray-300 rounded-md p-2 file:mr-4
                file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:bg-gray-700
                file:text-[white] hover:file:bg-gray-500' required accept='video/*,application/pdf'
                onChange={(e) => setVideoUrl(e.target.files[0])} />
            </div>
            <div className='flex items-center gap-3'>
                <input type="checkbox" className='accent-[black] h-4 w-4' id="isFree" 
                onChange={()=>setIsPreviewFree(prev=>!prev)}/>
                <label htmlFor="isFree" className='text-sm text-gray-700'>Is Video/pdf FREE ?</label>
            ...
            <div className='pt-4'>
                ...
                hover:bg-gray-700 transition' disabled={loading}
