      ...
      <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e) => { e.preventDefault(); }}>
        ...
        <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col justify-center items-center gap-3'>
          ...
          <div className='flex flex-col gap-1 w-[80%] items-start justify-center px-3'>
            <label htmlFor='name' className='font-semibold'>Name</label> {/* htmlFor se agar hum label pe click kare to input pe focus ho jata hai */}
            <input type="text" id='name' placeholder='Your Name' className='w-[100%] h-[35px] rounded-lg border-1 border-[#e7e6e6] text-[15px] px-[20px]' 
          ...
          <div className='flex flex-col gap-1 w-[80%] items-start justify-center px-3 relative'>
            ...
            <input type={show ? "text" : "password"} id='password' placeholder='Your Password' className='w-[100%] h-[35px] rounded-lg border-1 border-[#e7e6e6] text-[15px] px-[20px]' 
          ...
          <div className='flex md:w-[50%] w-[70%] items-center justify-between'>
            <span className={`px-[10px] py-[5px] border-[2px] rounded-xl border-[#e7e6e6] cursor-pointer hover:border-black
          ...
          <div className='text-[15px] text-[#6f6f6f]'>Already have an account? <span className='text-[blue] cursor-pointer' onClick={()=>navigate('/login')}>Login</span></div>
