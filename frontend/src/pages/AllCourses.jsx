...
const AllCourses = () => {
  ...
  // we use effect jisse uper ke dono func click karte hi work karne lage
  useEffect(()=>{
  ...
  return (
    <div className='flex min-h-screen bg-gray-50'>
      ...
      border-r border-gray-200 shadow-md transition-transform duration-300 z-5 ${isSidebarVisible ? "translate-x-0" : "-translate-x-full"}
      md:block md:translate-x-0`}>
        ...
        onSubmit={(e)=>e.preventDefault()}>
          <button className='px-[10px] py-[10px] bg-black text-white rounded-[10px] text-[15px] font-light
          ...
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            ...
            value={'Btech 1st Year'} onChange={toggleCategory}/>
            Btech 1st Year
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Btech 2nd Year'} onChange={toggleCategory}/>
            Btech 2nd Year
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Btech 3rd Year'} onChange={toggleCategory}/>
            Btech 3rd Year
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Btech 4th Year'} onChange={toggleCategory}/>
            Btech 4th Year
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Btech (Honours Degree)'} onChange={toggleCategory}/>
            Btech (Honours Degree)
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
          ...
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'AI Tools'} onChange={toggleCategory}/>
            AI Tools
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Data Science'} onChange={toggleCategory}/>
            Data Science
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Data Analytics'} onChange={toggleCategory}/>
            Data Analytics
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Devops'} onChange={toggleCategory}/>
            DevOps
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
          ...
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'UI UX Designing'} onChange={toggleCategory}/>
            UI UX Designing
          </label>
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
          ...
          <label htmlFor="" className='flex items-center gap-3 cursor-pointer hover:text-gray-200 transition'>
            <input type="checkbox" className="accent-black w-4 h-4 rounded-md"
            value={'Others'} onChange={toggleCategory}/>
            Others
          </label>
        </form>
